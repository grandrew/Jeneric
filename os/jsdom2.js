// modified version of xml-for-script parser
// for the Jeneric project
// by Andrew Gryaznov, 2009, realgrandrew@gmail.com
// LICENSE: GPLv3
...
DOMNode.prototype.setNodeValue = function DOMNode_setNodeValue(nodeValue) {
  ...
  if(this.___link) this.___link.nodeValue = nodeValue; // XXX SECURITY CHECK HERE
...
DOMNode.prototype.getChildNodes = function DOMNode_getChildNodes() {
  return this.childNodes; // XXX _underscore methods become available?? change them to ___ triple underscore
};
 ...
 * @author Jon van Noort (jon@webarcana.com.au)
 *
 * @return : DOMNamedNodeList // or Map ??? GDW
 */
 ...
 */
 ...
 // TODO XXX JENERIC not supported
...
DOMNode.prototype.insertBefore = function DOMNode_insertBefore(newChild, refChild) {
  ...
  if (refChild) {                                // if refChild is specified, insert before it
    ...
    // GDW
    if(newChild.___link && refChild.___link && this.___link ) this.___link.insertBefore(newChild.___link, refChild.___link);
...
DOMNode.prototype.replaceChild = function DOMNode_replaceChild(newChild, oldChild) {
  ...
  ret = this.childNodes._replaceChild(newChild, index);
    ...
    // GDW
    if(newChild.___link && oldChild.___link && this.___link ) this.___link.replaceChild(newChild.___link, oldChild.___link);
    this.ownerDocument.___DOMcache_outdated = true;
...
DOMDocument.prototype.createAttribute = function DOMDocument_createAttribute(name) {
  ...
  node.name     = name;
  node.nodeName = name;
  if(document.createAttribute) node.___link = document.createAttribute(name);
  return node;
};
...
/**
 * @method DOMElement.bind_real_dom - create a DOM link based on browser's DOM capability
 *
 * @author Andrew Andreevich Gryaznov (realgrandrew@gmail.com)
 *
 * @return : none
 */
...
DOMElement.prototype.setAttribute = function DOMElement_setAttribute(name, value) {
  ...
  */
  ...
  if (this.ownerDocument.implementation.errorChecking) {
    ...
    if (!this.ownerDocument.implementation._isValidString((new String(value)))) {
      throw(new DOMException(DOMException.INVALID_CHARACTER_ERR));
    }
  }
  ...
  if (this.ownerDocument.implementation._isIdDeclaration(name)) {
    ...
    // if(this.___link) // XXX dont mess with IDs!
  }
  ...
  var value = new String(value); // mess for the below
...
DOMElement.prototype.removeAttributeNode = function DOMElement_removeAttributeNode(oldAttr) {
  ...
  if(this.___link && oldAttr.___link && this.___link.removeAttributeNode) this.___link.removeAttributeNode(oldAttr.___link);
...
DOMCharacterData.prototype.setData = function DOMCharacterData_setData(data) {
  // delegate to setNodeValue
  //if(this.___link) this.___link.nodeValue = data;
...
DOMCharacterData.prototype.substringData = function DOMCharacterData_substringData(offset, count) {
  var ret = null;
  if(this.___link) this.data = this.___link.nodeValue;
  if (this.data) {
...
DOMCharacterData.prototype.appendData    = function DOMCharacterData_appendData(arg) {
  ...
  if(this.___link) this.___link.appendData(arg);
};
...
DOMCharacterData.prototype.insertData    = function DOMCharacterData_insertData(offset, arg) {
  ...
  if(this.___link) this.___link.insertData(offset, arg);
};
...
DOMCharacterData.prototype.deleteData    = function DOMCharacterData_deleteData(offset, count) {
  ...
  if(this.___link) this.___link.deleteData(offset, count);
};
...
DOMCharacterData.prototype.replaceData   = function DOMCharacterData_replaceData(offset, count, arg) {
  ...
  if(this.___link) this.___link.replaceData(offset, count, arg);
